...
uses
  Classes, SysUtils, Dialogs, strutils, CLScheduleCell, math, CLFilter, CLMetadata;
...
function GetFileName(SaveDialogFilter: string): string;
...
var
  ...
  content: TStringList;
begin
  fileName := GetFileName('Веб-страница (*.htm;*.html)|*.htm;*.html|');
  if fileName = '' Then exit;
